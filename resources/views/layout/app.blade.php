...
<nav class="flex items-center justify-between flex-wrap bg-blue-900 p-6 sticky -top-0" >
  <div class="flex items-center flex-shrink-0 text-white mr-6">
    ...
    <span class="font-semibold text-xl tracking-tight">BMC</span>
  </div>
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <div class="text-sm lg:flex-grow">
      <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 text-white text-teal-200 hover:text-yellow-400 mr-4">
       Docs 
      </a>
      <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 text-white text-teal-200 hover:text-yellow-400 mr-4">
        Examples
      </a>
      <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0  text-white text-teal-200 hover:text-yellow-400">
        Blog
      </a>
    </div>
    <div>
        ...
        <div class="sm:flex sm:mt-8">
            <div class="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-between">
                <div class="flex flex-col">
                    <span class="font-bold text-gray-300 uppercase mb-2">Footer header 1</span>
                    <span class="my-2"><a href="#" class="text-gray-300   text-md hover:text-yellow-600">link 1</a></span>
                    <span class="my-2"><a href="#" class="text-gray-300   text-md hover:text-yellow-600">link 1</a></span>
                    <span class="my-2"><a href="#" class="text-gray-300   text-md hover:text-yellow-600">link 1</a></span>
                ...
                <div class="flex flex-col">
                    <span class="font-bold text-gray-300 uppercase mt-4 md:mt-0 mb-2">Footer header 2</span>
                    <span class="my-2"><a href="#" class="text-gray-300   text-md hover:text-yellow-600">link 1</a></span>
                    <span class="my-2"><a href="#" class="text-gray-300   text-md hover:text-yellow-600">link 1</a></span>
                    <span class="my-2"><a href="#" class="text-gray-300   text-md hover:text-yellow-600">link 1</a></span>
                ...
                <div class="flex flex-col">
                    <span class="font-bold text-gray-300  uppercase mt-4 md:mt-0 mb-2">Footer header 3</span>
                    <span class="my-2"><a href="#" class="text-gray-300   text-md hover:text-yellow-600">link 1</a></span>
                    <span class="my-2"><a href="#" class="text-gray-300   text-md hover:text-yellow-600">link 1</a></span>                  
                    <span class="my-2"><a href="#" class="text-gray-300   text-md hover:text-yellow-600">link 1</a></span>
